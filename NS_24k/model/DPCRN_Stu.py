...
class DPCRN_Model(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=2, out_channels=16, kernel_size=(1, 5), stride=(1, 2), padding=(0, 1)),
            nn.BatchNorm2d(16),
            nn.PReLU(),
        )
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=16, out_channels=16, kernel_size=(1, 3), stride=(1, 1), padding=(0, 1)),
            nn.BatchNorm2d(16),
            nn.PReLU(),
        )

        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(1, 3), stride=(1, 1), padding=(0, 1)),
            nn.BatchNorm2d(32),
            nn.PReLU(),
        ...
        self.DPRNN_1 = DPRNN_Block(numUnits=64, width=50)
        self.DPRNN_2 = DPRNN_Block(numUnits=64, width=50)
        ...
        self.convT2 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=64, out_channels=16, kernel_size=(1, 3), stride=(1, 1), padding=(0, 0)),
            nn.BatchNorm2d(16),
            nn.PReLU(),
        )

        self.convT3 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=(1, 3), stride=(1, 1), padding=(0, 0)),
            nn.BatchNorm2d(16),
            nn.PReLU(),
        )

        self.convT4 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=(1, 3), stride=(1, 2), padding=(0, 0)),
            nn.BatchNorm2d(16),
            nn.PReLU(),
        )
        ...
        self.convT5 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=32, out_channels=2, kernel_size=(1, 5), stride=(1, 2), padding=(0, 0)),
        )
    ...
    def forward(
        ...
        return enh_real, enh_imag, DPRNN_out1, DPRNN_out2
...
if __name__ == '__main__':
    ...
    enh_real, enh_imag, _, _ = Model(inputs)
