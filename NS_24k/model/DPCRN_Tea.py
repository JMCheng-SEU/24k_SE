...
class DPCRN_Model(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=2, out_channels=64, kernel_size=(1, 5), stride=(1, 2), padding=(0, 1)),
            nn.BatchNorm2d(64),
            nn.PReLU(),
        )
        ...
        self.DPRNN_1 = DPRNN_Block(numUnits=256, width=50)
        self.DPRNN_2 = DPRNN_Block(numUnits=256, width=50)


        self.convT1 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=512, out_channels=128, kernel_size=(1, 3), stride=(1, 1), padding=(0, 0)),
            nn.BatchNorm2d(128),
            nn.PReLU(),
        )
        ...
        self.convT4 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(1, 3), stride=(1, 2), padding=(0, 0)),
            nn.BatchNorm2d(64),
            nn.PReLU(),
        )
        ...
        self.convT5 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=128, out_channels=2, kernel_size=(1, 5), stride=(1, 2), padding=(0, 0)),
        )
