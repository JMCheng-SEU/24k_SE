...
class DPRNN_Block(nn.Module):
    ...
    def forward(self, input: Tensor) -> Tensor:
        ...
        intra_out = intra_ln_input.permute(0, 3, 1, 2)
        ...
        inter_out = inter_ln_input.permute(0, 3, 2, 1)
...
class DPCRN_Model_new_Lite(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.DPRNN_1 = DPRNN_Block(numUnits=64, width=32)
        self.DPRNN_2 = DPRNN_Block(numUnits=64, width=32)
