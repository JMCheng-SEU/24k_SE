...
class DCCRN(nn.Module):
    def __init__(self,
                 rnn_layer=1, rnn_hidden=128,
                 win_len=400, hop_len=100, fft_len=512, win_type='hanning',
                 use_clstm=False, use_cbn=False, masking_mode='E',
                 kernel_size=5, kernel_num=(4, 8, 16, 32, 32, 32)
                 ):    ######### pre_size:(32, 64, 128, 256, 256, 256)
                ...
                self.decoder.append(
                    nn.Sequential(
                        ComplexConvTranspose2d(
                            self.kernel_num[idx],   # self.kernel_num[idx] * 2
                            self.kernel_num[idx - 1],
                            kernel_size=(self.kernel_size, 1),
                            stride=(2, 1),
                            padding=(1, 0),
